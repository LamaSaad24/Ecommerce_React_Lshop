                    ...
                    <div className="col-lg-9 col-md-12">
                        <div className="row pb-3">
                            <div className="col-12 pb-1">
                                <div className="d-flex align-itemsX-center justify-content-between mb-4">
                                    <form action="">
                            ...
                            {isLoading ? "isLoading..." : <>
                                {data?.products.map(product => {
                                    return (<div className="col-lg-4 col-md-6 col-sm-12 pb-1" key={product._id}>
                                        <div className="card product-item border-0 mb-4">
                                            <div className="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                                <img className="img-fluid w-100" src={product.mainImage.secure_url} alt={product.slug} />
                                            </div>
                                            <div className="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                                <h6 className="text-truncate mb-3">{product.name}</h6>
                                                <div className="d-flex justify-content-center">
                                                    <h6>${product.price}</h6><h6 className="text-muted ml-2"><del>${product.finalPrice}</del></h6>
                                                </div>
                                            </div>
